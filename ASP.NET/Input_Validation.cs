...
app.MapPost("/api/categories", (Category category_data) =>
{
    ...
    {
        return Results.BadRequest("Category Name is Required!! Your should give name");
    }

    if(category_data.Name.Length < 2) {
        return Results.BadRequest("You Must Enter the name of length is Minimum 3");
    }
    var New_category = new Category
    {
...
// Update
app.MapPut("/api/categories/{id:guid}", (Guid id, Category category_data) =>
{
